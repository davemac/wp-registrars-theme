	...
	register_post_type(
		...
		array(
			'labels'                => array(
				...
				'singular_name'         => __( 'Job', 'dmcstarter' ),
				...
				'new_item'              => __( 'New Job', 'dmcstarter' ),
				'add_new'               => __( 'Add New', 'dmcstarter' ),
				'add_new_item'          => __( 'Add New Job', 'dmcstarter' ),
				'edit_item'             => __( 'Edit Job', 'dmcstarter' ),
				'view_item'             => __( 'View Job', 'dmcstarter' ),
...
function dmc_job_updated_messages( $messages ) {
	...
	$messages['dmc-job'] = array(
		...
		9  => sprintf(
			__( 'Jobs scheduled for: <strong>%1$s</strong>. <a target="_blank" href="%2$s">Preview Jobs</a>', 'dmcstarter' ),
